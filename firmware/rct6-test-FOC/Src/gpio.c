...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, cs1_Pin|SPI_SCK_Pin|SPI_MOSI_Pin|cs2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : cs1_Pin SPI_SCK_Pin SPI_MOSI_Pin gate1_Pin
                           cs2_Pin */
  GPIO_InitStruct.Pin = cs1_Pin|SPI_SCK_Pin|SPI_MOSI_Pin|gate1_Pin
                          |cs2_Pin;
