...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, cs1_Pin|gate1_Pin|cs2_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : cs1_Pin sck_Pin mosi_Pin gate1_Pin
                           cs2_Pin */
  GPIO_InitStruct.Pin = cs1_Pin|sck_Pin|mosi_Pin|gate1_Pin
                          |cs2_Pin;
